...
init_sprite:
    ...
    lda #$02
    sta $d028
    jsr init_stationary_ghost
    rts

init_stationary_ghost:
    ldx #GHOST_START_CELL_X
    lda sprite_x_lo_by_cell,x
    sta $d002
    ldx #GHOST_START_CELL_Y
...
check_stationary_ghost_collision:
    lda pac_cell_x
    cmp #GHOST_START_CELL_X
    bne no_stationary_ghost_collision
    lda pac_cell_y
    cmp #GHOST_START_CELL_Y
    bne no_stationary_ghost_collision
    jsr trigger_pacman_expiration
no_stationary_ghost_collision:
    rts
...
def main(argv: list[str]) -> int:
    ...
    intent = {
        ...
        "spriteProjection": {
            ...
            "spriteCopyFix": "copies all 576 bytes for nine sprite frames including the stationary ghost",
