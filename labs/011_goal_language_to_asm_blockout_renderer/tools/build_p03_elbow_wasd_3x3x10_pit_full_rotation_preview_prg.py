...
OUT_PRG = LAB / "dist" / "p03_elbow_wasd_3x3x10_pit_full_rotation_preview.prg"
OUT_META = LAB / "dist" / "p03_elbow_wasd_3x3x10_pit_full_rotation_preview_metadata.json"
...
def main():
    ...
    meta = {
        ...
        "program": str(OUT_PRG),
        "pieceId": "P03_ELBOW",
        "mode": "P03_ELBOW WASD 3x3x10 pit full-rotation preview",
