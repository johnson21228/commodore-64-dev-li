...
OUT_PRG = LAB / "dist" / "p03_elbow_true_axis_endpoint_3x3_green_line_pit_only_preview.prg"
OUT_META = LAB / "dist" / "p03_elbow_true_axis_endpoint_3x3_green_line_pit_only_preview_metadata.json"
...
def main():
    ...
    meta = {
        ...
        "program": str(OUT_PRG),
        "pieceId": "P03_ELBOW",
        "mode": "P03_ELBOW 3x3 green-line pit-only diagnostic preview",
        ...
        "knownArtifact": "Pit-only diagnostic has no active-block white color-cell writes; all pit bitmap bits should display as green.",
        "sizes": sizes,
        "prgBytes": len(image),
